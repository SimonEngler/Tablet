...
public final class dataDDSTypeSupport implements TypeSupport{
  ...
  public int     marshall ( ByteBuffer out_stream,  dataDDS src ) {
    ...
    if ( out_stream == null ) {
      ...
      // src.data_image_DDS
      // src.data_image_DDS.length
      size = (size+3) & 0xfffffffc;// align 4
      size += 4;
      if (src.data_image_DDS != null) {
        for (int i7 = 0; i7 < src.data_image_DDS.length; i7++ ) {
          // src.data_image_DDS[i7]
          size += 1;
        }
      }
    } else {
      ...
      // src.data_image_DDS.length
      while((out_stream.position() & 0x03) != 0) out_stream.put((byte)0x00); // align 4
      out_stream.putInt(src.data_image_DDS.length);
      for (int i7 = 0; i7 < src.data_image_DDS.length; i7++ ) {
          // src.data_image_DDS[i7]
          out_stream.put((byte)src.data_image_DDS[i7]);
      }
  ...
  public int     unmarshall ( dataDDS t, ByteBuffer data, int s )    {
    ...
    if ((encoding & 0x02)==0) { // CDR encoding
      ...
      // t.data_image_DDS
      // t.data_image_DDS.length
      while((data.position() & 0x03) != 0) data.position(data.position()+1); // align 4
      int    slen7 = data.getInt();
      t.data_image_DDS = new byte[slen7];
      for (int i7 = 0; i7 < t.data_image_DDS.length; i7++ ) {
        // t.data_image_DDS[i7]
        t.data_image_DDS[i7] = data.get();
      }
    }
  ...
  public int gen_typecode( ByteBuffer b ) {
    byte[] tc_data = { 
(byte)0x0a, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0xf4, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x08, (byte)0x00, (byte)0x00, (byte)0x00, (byte)'d', (byte)'a', (byte)'t', (byte)'a', (byte)'D', (byte)'D', (byte)'S', (byte)0x00, (byte)0x07, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x1c, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x09, (byte)0x00, (byte)0x00, (byte)0x00, (byte)'X', (byte)'V', (byte)'e', (byte)'l', (byte)'_', (byte)'D', (byte)'D', (byte)'S', (byte)0x00, (byte)0x00, (byte)0xff, (byte)0xff, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x05, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x1a, (byte)0x00, (byte)0x09, (byte)0x00, (byte)0x00, (byte)0x00, (byte)'Y', (byte)'V', (byte)'e', (byte)'l', (byte)'_', (byte)'D', (byte)'D', (byte)'S', (byte)0x00, (byte)0x00, (byte)0xff, (byte)0xff, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x05, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x1e, (byte)0x00, (byte)0x0f, (byte)0x00, (byte)0x00, (byte)0x00, (byte)'C', (byte)'o', (byte)'m', (byte)'p', (byte)'a', (byte)'s', (byte)'s', (byte)'D', (byte)'i', (byte)'r', (byte)'_', (byte)'D', (byte)'D', (byte)'S', (byte)0x00, (byte)0x00, (byte)0xff, (byte)0xff, (byte)0x00, (byte)0x00, (byte)0x05, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x1a, (byte)0x00, (byte)0x0b, (byte)0x00, (byte)0x00, (byte)0x00, (byte)'G', (byte)'P', (byte)'S', (byte)'_', (byte)'L', (byte)'N', (byte)'_', (byte)'D', (byte)'D', (byte)'S', (byte)0x00, (byte)0x00, (byte)0xff, (byte)0xff, (byte)0x00, (byte)0x00, (byte)0x05, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x1a, (byte)0x00, (byte)0x0b, (byte)0x00, (byte)0x00, (byte)0x00, (byte)'G', (byte)'P', (byte)'S', (byte)'_', (byte)'L', (byte)'T', (byte)'_', (byte)'D', (byte)'D', (byte)'S', (byte)0x00, (byte)0x00, (byte)0xff, (byte)0xff, (byte)0x00, (byte)0x00, (byte)0x05, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x20, (byte)0x00, (byte)0x08, (byte)0x00, (byte)0x00, (byte)0x00, (byte)'L', (byte)'o', (byte)'g', (byte)'_', (byte)'D', (byte)'D', (byte)'S', (byte)0x00, (byte)0x00, (byte)0x00, (byte)0xff, (byte)0xff, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x0d, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x06, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0xff, (byte)0xff, (byte)0xff, (byte)0xff, (byte)0x2c, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x0f, (byte)0x00, (byte)0x00, (byte)0x00, (byte)'d', (byte)'a', (byte)'t', (byte)'a', (byte)'_', (byte)'i', (byte)'m', (byte)'a', (byte)'g', (byte)'e', (byte)'_', (byte)'D', (byte)'D', (byte)'S', (byte)0x00, (byte)0x00, (byte)0xff, (byte)0xff, (byte)0x00, (byte)0x00, (byte)0x0e, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x0c, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0xff, (byte)0xff, (byte)0xff, (byte)0xff, (byte)0x09, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00,     };
